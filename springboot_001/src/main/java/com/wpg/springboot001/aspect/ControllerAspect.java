package com.wpg.springboot001.aspect;
...
public class ControllerAspect {
     ...
     */
    @Pointcut("execution(public * com.wpg.springboot001.aspect.*.controller.*.*(..))")
    @Order(1)
    public void controllerPointCut() {}

    @Before(value = "com.wpg.springboot001.aspect.ControllerAspect.controllerPointCut()")
    ...
    @Around(value = "com.wpg.springboot001.aspect.ControllerAspect.controllerPointCut()")
    ...
    @After(value = "com.wpg.springboot001.aspect.ControllerAspect.controllerPointCut()")
